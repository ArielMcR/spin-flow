...
class _FormSalaState extends State<FormSala> {
  ...
  final _numBikesController = TextEditingController(text: '0');
  final _numFilasController = TextEditingController(text: '0');
  final _limiteBikesController = TextEditingController(text: '0');
  ...
  void dispose() {
    ...
    _numBikesController.dispose();
    _numFilasController.dispose();
    _limiteBikesController.dispose();
    super.dispose();
  }
    ...
    return Row(
      children: [
        ...
        Expanded(
          flex: 1,
          child: TextFormField(
            controller: _numBikesController,
        ...
        Expanded(
          flex: 1,
          child: TextFormField(
            controller: _numFilasController,
        ...
        Expanded(
          flex: 1,
          child: TextFormField(
            controller: _limiteBikesController,
  ...
  void _atualizarNumeros() {
    final nBikes = int.tryParse(_numBikesController.text) ?? 0;
    final nFilas = int.tryParse(_numFilasController.text) ?? 0;
    final limiteBikes = int.tryParse(_limiteBikesController.text) ?? 0;
